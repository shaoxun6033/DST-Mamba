...
parser = argparse.ArgumentParser(description='DST-Mamba for Time Series Forecasting')
...
parser.add_argument('--model', type=str, required=False, default='DST-Mamba',
...
parser.add_argument('--num_nodes', type=int, default=8, help='to create Graph')
parser.add_argument('--moe_experts', type=int, default=4, help='Number of experts in MoE')
parser.add_argument('--moe_k', type=int, default=2, help='Top-k experts to activate')
...
# DLinear
parser.add_argument('--dlinear_individual', action='store_true', default=False,
                    help='DLinear individual head')
# Formers
